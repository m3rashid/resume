%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Original author:
% MD Rashid Hussain (http://m3rashid.in)
%
...
\runsubsection{Yantraksh Logistics}
\descript{|  Frontend Developer }
\location{Sept 2022 - Current | Hybrid}
\vspace{\topsep} 
\begin{tightemize}
...
\runsubsection{Google Developers Student Club, JMI}
\descript{|  Cloud Team Lead}
\location{Oct 2022 – Current}
\begin{tightemize}
...
% \item Took technical sessions for Web Developer Roadmaps
% \end{tightemize}
% \sectionsep
...
\descript{|  Hospital management system}
